    ...
    Menu.prototype.handleFold = function() {
        ...
        this.$.on('click', '.nav-parent > a', function(event) {
            if(auto) {
                ...
                $menu.find('.font-icon-rotate-90').removeClass('font-icon-rotate-90');
            }

            var li = $(this).closest('.nav-parent');
            if(li.hasClass('show')) {
                li.find('.font-icon-rotate-90').removeClass('font-icon-rotate-90');
                li.find('.nav').slideUp(function() {
                    $(this).closest('.nav-parent').removeClass('show');
                });
            } else {
                li.find('.nav-parent-fold-icon').addClass('font-icon-rotate-90');
...
(function ($, w) {
    ...
    var methods = (function () {
        ...
        var c = {
                ...
                anchorClass: 'menu-with-ul',
                menuArrowClass: 'menu-arrows'
            },
            ios = (function () {
    ...
    $.fn.superfish.defaults = {
        popUpSelector: 'ul,.menu-mega-box', // within menu context
